 ...
 * Usa tokens de tema (bg-input / text-fg) para acompanhar claro e escuro.
...
export function CodeEditor({
  ...
  return (
    <div className={cn('overflow-hidden rounded-[10px] border border-border bg-input', className)}>
      ...
      <textarea
        ...
        spellCheck={false}
        className="block w-full resize-y bg-transparent px-4 py-3 font-mono text-[13px] leading-[1.7] text-fg outline-none placeholder:text-subtle"
