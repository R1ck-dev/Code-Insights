    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        // Perfil proprio exige autenticacao (precede a regra publica /api/usuarios/* abaixo).
                        .requestMatchers(HttpMethod.GET, "/api/usuarios/me").authenticated()
                        // Diretorio de portfolios (tela Explorar): publico, pois so lista perfis
                        // que ja sao publicos. Serve as duas rotas do front: /explorar e /app/explorar.
                        .requestMatchers(HttpMethod.GET, "/api/usuarios/publicos").permitAll()
